...
import { Activity, FileImage, Image as ImageIcon, LayoutDashboard, MessageCircle, MessageSquare, Settings2, Zap } from "lucide-react";
...
export const Route = createFileRoute("/instagram")({
  beforeLoad: ({ location }) => {
    if (location.pathname === "/instagram" || location.pathname === "/instagram/") {
      throw redirect({ to: "/instagram/dashboard" });
    }
  },
  head: () => ({
    meta: [
